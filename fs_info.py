# https://github.com/dhylands/upy-examples/blob/master/fs_info.py
# Script which runs on MicroPython and prints info about
# the filesystem which is currently running.
#
# This was taken from:
#   https://forum.micropython.org/viewtopic.php?p=64410#p64410
...
def decode_bootsec_fat(b):
    ...
    pr(32, 'volume size (32-bit) (sectors)',
...
def main():
    ...
    used = total - (stats[0] * stats[3])
    pr(0000, 'program memory', total)
    pr(0000, 'used memory', used)
    pr(0000, 'free memory', (stats[0] * stats[3]))
